...
window.addEventListener('scroll', function() {
    ...
    if (window.scrollY > 50) {
        navbar.style.backgroundColor = 'rgba(241, 156, 0, 0.95)';
...
console.log('%c🎨 Paint Guard Website', 'color: #F19C00; font-size: 20px; font-weight: bold;');
console.log('%cDeveloped for LFJ Plastics Ltd', 'color: #201C42; font-size: 14px;');
